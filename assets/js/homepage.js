...
function loadAvatars() {
  ...
  // $.ajax({
  //   type: 'GET',
  //   url: 'https://api.github.com/repos/owid/owid-grapher/contributors',
  //   dataType: 'json',
  ...
  $.ajax({
    ...
    success: function(response) {
      ...
      if (Array.isArray(response)) {
        // Extract avatar URLs from the response
        avatars = response.map(contributor => contributor.avatar_url);
    ...
    error: function(xhr, status, error) {
      console.error("Error fetching avatars:", status, error);
    }
  });
}
